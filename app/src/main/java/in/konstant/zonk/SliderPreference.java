...
public class SliderPreference
    ...
    private int mDefault, mMaximum, mMinimum, mValue = 0;
...
//        mMinimum = attributeSet.getAttributeIntValue(androidns, "min", 0);
        mMaximum = attributeSet.getAttributeIntValue(androidns, "max", 100);
    }
    ...
    protected View onCreateDialogView() {
        ...
        mMessageText.setPadding(30, 10, 30, 10);
